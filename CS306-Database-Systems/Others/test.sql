...
--
-- Anamakine: 127.0.0.1
-- Üretim Zamanı: 13 Oca 2021, 18:55:31
...
(8, 'mypass8', 'mymail8@gmail', 25, 0, 41.7896, 34.7976),
...
(144, 8, 142, 0.3, '2020-12-25', 'Izmir', 'Istanbul', 11, 154);
...
--
ALTER TABLE `buy`
  ADD CONSTRAINT `buy_ibfk_2` FOREIGN KEY (`ticket_id`) REFERENCES `ticket` (`ticket_id`) ON DELETE CASCADE ON UPDATE CASCADE,
...
ALTER TABLE `shopping_history`
  ...
  ADD CONSTRAINT `shopping_history_ibfk_3` FOREIGN KEY (`ticket_id`) REFERENCES `buy` (`ticket_id`) ON DELETE CASCADE;
