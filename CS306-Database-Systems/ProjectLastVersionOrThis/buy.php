	...
	<div class="table">
		<table>
			...
			$sql_statement6 = "SELECT T.destination, T.startpoint, T.flight_time,T.company_id, Ca.percentage,T.ticket_id,T.seat_no,T.company_name,T.ticket_price
                           ...
                           WHERE T.flight_id = $flight_id and T.seat_no = $seat_no;";
			...
			while($row40 = mysqli_fetch_assoc($result10))
			{
				...
				echo "</th>" . "<th>" . $from . "</th>" . "<th>" . $to . "</th>" . "<th>" . $date . "</th>" ."<th>" . $price . "</th>". "<th>" . $flight_id . "</th>"."<th>" .$seat_no ."</th>"." <td><a href=\"buyed.php?id=".$flight_id."&status=app\">Buy</a> </td>.</tr>";
