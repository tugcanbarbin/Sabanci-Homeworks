		...
		<div class="container">
			...
			<div class="box">
				...
				<div class="content">					
					...
					<label for="asc"><strong>ASC PRICE</strong></label>
						
					<br><br>
					<input type="radio" id="desc" name="desc" value="DESC">
					<label for="desc"class="ordered"><strong>DESC PRICE</strong></label>
			...
			<div class="box">
				...
				<div class="content">
					...
					<br><br><br><br>
					<input type="radio" id="recent" name="recent" value="Show recent">
					<label for="recent"><strong> SHOW RECENT</strong></label>	
				</div>
			</div>
		</div>
		<div>
